		...
		<div class="box-body no-padding">
		  <table class="table table-striped ">
			...
			<?php 	
				...
				{
					echo '<tr>
					<td><input type="checkbox" name="checkbox[]" value="' . $category_list_data->category_id . '" id="checkbox[]" class="checkbox1""></td>
					<td>' . $sl++. '</td>
...
//                    return  false;
			$.ajax({
				url: '<?php echo base_url() ?>backend_category/publish',
				type: 'post',
...
//                    return  false;
			$.ajax({
				url: '<?php echo base_url() ?>backend_category/unpublish',
				type: 'post',
				data: 'ids=' + checkValues
			}).done(function(data) {
				$(".respose").html(data);
